...
Fibonacci heap performance for operatios viz. $insert$ and $meld$ are shown in Figure \ref{fig:fi_insert_meld}. The curves have mountainous terrain as it the amortized total expected cost.
...
\begin{itemize}
	...
	\item $rkt-heaps$ provide an efficient implementation of Fibonacci heaps using doubly linked lists(DDL)
